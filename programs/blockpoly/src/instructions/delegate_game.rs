...
pub struct DelegateGame<'info> {
    ...
    #[account(
        ...
        constraint = game_state.status == GameStatus::InProgress @ BlockpolyError::GameNotStarted,
    )]
    ...
    // remaining_accounts: PlayerState PDAs to delegate
}
...
pub fn handler<'a, 'b, 'c, 'info>(
    ...
    // Delegate each PlayerState passed as remaining_accounts
