...
export const ALPHA_CALL_CARDS: CardDef[] = [
  ...
  { id: 2, deck: "alpha", name: "Advance to Nearest Bridge", description: "Move to nearest Wormhole/deBridge/Allbridge/Mayan. Pay 2x rent if owned" },
  ...
  { id: 6, deck: "alpha", name: "MEV Bot Attack", description: "Pay toll = last dice roll x 4 BPOLY to bank" },
